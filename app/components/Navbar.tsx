    ...
    <nav className="bg-[#1D202369] top-0 shadow-md fixed w-full z-[99999]">
      <div className="container mx-auto px-4 flex justify-between items-center py-4">
        ...
        <ul
          ...
          } absolute bg-[#1D202369] text-white md:text-[#AEB5AD] md:bg-transparent top-full left-0 w-full shadow-md md:relative md:flex md:gap-6 md:items-center md:w-auto md:shadow-none`}
        >
